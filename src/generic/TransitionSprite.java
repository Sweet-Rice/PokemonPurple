...
private boolean fadeOut;
    public TransitionSprite(Scene sc, int goal, boolean fadeOut) {
        ...
        this.image = new BufferedImage(sc.getSpriteComponent().getWidth(), sc.getSpriteComponent().getHeight(), BufferedImage.TYPE_INT_ARGB);
    ...
    private void perform(){
        ClockWorker.addTask(new Task(255) {
            ...
            public void run() {
                ...
                speed = iteration()*(iteration()/2);
                if (speed>255)speed=255;
                graphics.setColor(new Color(r,g,b,maxIteration()-speed));
                graphics.fillRect(0, 0, image.getWidth(), image.getHeight());
                setDrawingPriority(100);
    ...
    private void perform1(){
        ClockWorker.addTask(new Task(255) {
            ...
            public void run() {
                ...
                speed = iteration()*(iteration()/2);
                if (speed>255)speed=255;
                graphics.setColor(new Color(r,g,b,speed));
                graphics.fillRect(0, 0, image.getWidth(), image.getHeight());
                setDrawingPriority(100);
                setPicture(new Picture(newImage));
            }
